...
function assembleglobalK(elementalKs, p::AbstractOptParams)
...
function ChainRulesCore.rrule(::typeof(assembleglobalK), Eks, p::AbstractOptParams)
    K = assembleglobalK(Eks, p)
